...
// alert('Hello ' + bowser.name + ' ' + bowser.version + ' ' + bowser.osname);
// alert('mobile: ' + bowser.mobile + ' - tablet:' + bowser.tablet);
document.documentElement.className += ' ' + bowser.name.toLowerCase();
...
/*! js-cookie v2.2.0 | MIT  https://github.com/js-cookie/js-cookie */
...
//Cookies.get('name');
//Cookies.remove('name');
/*! js-cookie 13.04.18 | MIT  https://github.com/js-cookie/js-cookie /z*/
...
function loadjscssfile(filename, filetype){
	if (jscssfileadded.indexOf("["+filename+"]")===-1){
		...
		jscssfileadded+="["+filename+"]"; //List of files added in the form "[filename1],[filename2],etc"
	}
}
...
function BlogArticlePage() {
	...
	if( typeof(DISQUS) !== 'undefined' ){
		...
		setTimeout(function() {
			// loadjscssfile("/_js/disqus.js", "js");
			loadjscssfile("/_js/disqus.min.js", "js");
		}, 1500);
	}
...
/* headroom.js */
// grab an element
var htmlTag = document.documentElement; // работает глобально
// var headerElement = document.querySelector("body");
// construct an instance of Headroom, passing the element
var headroom = new Headroom(htmlTag);
// initialise
headroom.init();
...
function onYouTubeIframeAPIReady() {
	...
	var yt_news_fig = _all('#yt-news figure');
...
if (Turbolinks.supported) {
	...
	document.addEventListener('turbolinks:load', function(event) {
		...
		if( qs('#yt-news') && (typeof(YT)==='undefined') ){
			loadjscssfile("https://www.youtube.com/iframe_api", "js");
		}
		if( qs('#yt-news') && (typeof(YT)!=='undefined') ){
		...
		if( qs('.lz') ){
			...
			if(bowser.name.toLowerCase() === 'firefox'){
				setTimeout(function() { bLazy.revalidate(); }, 750);
			}
		}
		...
		if( typeof(ga) !== 'undefined' ){
			...
			ga('set', 'page', event.data.url);
			ga('send', 'pageview');
		}
		/* google analytics for ajax /z*/
		// alert(typeof(Turbolinks))
